...
namespace Myfirstproject.CollectionsProgram.CustomListProg
{
    ...
    class ShipmentTask
    {
        static void Main(string[] args)
        {
            ...
            sh.Add(new Shipment(123, new Order(101, "Amit", "Nasik"), new MyDate(25, 12, 22)));
            sh.Add(new Shipment(128, new Order(102, "Rahul", "Pune"), new MyDate(26, 12, 22)));
            sh.Add(new Shipment(127, new Order(106, "Siddhart", "Mumbai"), new MyDate(28, 12, 22)));
            sh.Add(new Shipment(126, new Order(108, "Rohit", "Pune"), new MyDate(29, 12, 22)));
            sh.Add(new Shipment(122, new Order(107, "Parth", "Mumbai"), new MyDate(5, 12, 22)));
